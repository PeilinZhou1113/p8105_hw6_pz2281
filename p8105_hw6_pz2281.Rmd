...
Under repeated sampling, the value of $log(\hat{\beta_0} * \hat{\beta_1})$ is centered around 2 to 2.025. And there is a slightly longer tail on the left, indicating having lower estimated values occasionally.
