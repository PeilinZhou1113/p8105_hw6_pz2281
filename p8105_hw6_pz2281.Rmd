...
Making density plots and obtaining 95% confidence intervals for $\hat{r}^2$ and $log(\hat{\beta_0}*\hat{\beta_1})$.
```{r}
...
Under repeated sampling, the value of estimated $log(\hat{\beta_0}*\hat{\beta_1})$ is centered around 2 to 2.025. And there is a slightly longer tail on the left, indicating having lower estimated values occasionally.
