...
hypothesized model. The one that has higher adjusted
![r^2](https://latex.codecogs.com/png.latex?r%5E2 "r^2") value would be
...
higher ![r^2](https://latex.codecogs.com/png.latex?r%5E2 "r^2") value.
So the model I would use as hypothesized model is fit\_stepwise.
...
estimated ![R^2](https://latex.codecogs.com/png.latex?R%5E2 "R^2")
values of the fitted model is approximately normal and centered around
0.91.

95% confidence interval of estimated
...
Under repeated sampling, the value of
![log(\\hat{\\beta\_0} \* \\hat{\\beta\_1})](https://latex.codecogs.com/png.latex?log%28%5Chat%7B%5Cbeta_0%7D%20%2A%20%5Chat%7B%5Cbeta_1%7D%29 "log(\hat{\beta_0} * \hat{\beta_1})")
