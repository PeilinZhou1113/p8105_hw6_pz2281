...
*r̂*<sup>2</sup> and $log(\\hat{\\beta\_0}\*\\hat{\\beta\_1})$.
...
Distribution of $log(\\hat{\\beta\_0}\*\\hat{\\beta\_1})$:
...
Under repeated sampling, the value of estimated
$log(\\hat{\\beta\_0}\*\\hat{\\beta\_1})$ is centered around 2 to 2.025.
And there is a slightly longer tail on the left, indicating having lower
estimated values occasionally.

95% confidence interval for $log(\\hat{\\beta\_0}\*\\hat{\\beta\_1})$:
